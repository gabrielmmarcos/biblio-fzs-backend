...
from biblio_fzs_backend.routers.acervos import router as acervo_router
from biblio_fzs_backend.routers.tipos_acervos import router as tipos_acervos_router
from biblio_fzs_backend.routers.exemplares import router as exemplares_router
from biblio_fzs_backend.routers.emprestimos import router as emprestimos_router
from biblio_fzs_backend.routers.reservas import router as reservas_router
from biblio_fzs_backend.routers.avalicao import router as avaliacao_router
from biblio_fzs_backend.routers.lista import router as lista_router
...
app.include_router(tipos_acervos_router)
